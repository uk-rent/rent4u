      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://rentinlondon.online" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-white transition-colors">Contact Us</a></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Subscribe to our newsletter to receive updates on new properties and rental tips</p>
            <form className="space-y-2">
              <div className="flex flex-col sm:flex-row gap-2">
                <Input type="email" placeholder="Your email" className="bg-gray-700 border-gray-600 focus:ring-primary focus:border-primary text-white" />
                <Button className="bg-primary hover:bg-primary-hover text-white whitespace-nowrap">Subscribe</Button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">© {currentYear} rentinlondon. All rights reserved.</p>
          <p className="text-sm text-gray-400 mt-2 md:mt-0">A premium service for renting in London | rentinlondon.online</p>
        </div>
      </div>
